...
bool
Rayo::hallarColision(int mapa[][TAMANIO_FILA], double &interseccionAX, double &interseccionAY, double &xa, double &ya) {
...
bool Rayo::verificarInterseccionHorizontal(int mapa[][TAMANIO_FILA], double &distancia, Jugador &jugador) {
    ...
    std::cout << "primer punto de interseccion para horizontal :" << interseccionAX / this->ladoCelda << " y: "
              << interseccionAY / this->ladoCelda << "\n";
...
bool Rayo::verificarInterseccionVertical(int mapa[][TAMANIO_FILA], double &distancia, Jugador &jugador) {
    ...
    std::cout << "primer punto de interseccion para vertical :" << interseccionAX / this->ladoCelda << " y: "
              << interseccionAY / this->ladoCelda << "\n";
